      ...
      <div :class="[
        ...
        <div class="flex-1 overflow-y-auto">
          ...
          <div
            ...
            :class="[
              'touch-target p-3 sm:p-4 border-b border-orange-100/50 cursor-pointer transition-colors hover:bg-orange-50/50',
          ...
          >
            <div class="flex items-center space-x-3">
              ...
              <div class="flex-1 min-w-0">
                ...
                <div v-if="connection.lastMessage" class="text-xs text-gray-400 truncate leading-relaxed">
                  {{ connection.lastMessage }}
                </div>
              </div>
              <div v-if="connection.unreadCount > 0" class="w-5 h-5 bg-orange-500 text-white text-xs rounded-full flex items-center justify-center flex-shrink-0">
